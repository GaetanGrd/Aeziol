    ...
    string FillBrushKey)
{
    ...
    internal const string DiscordCracksPathData = "M32.2 3L33 3.1L32.7 11.2L31.9 11.1ZM32.3 10.7L33.1 10.5L34.4 16.8L33.6 17ZM33.7 16.4L34.5 16.6L32.9 24.3L32.1 24.1ZM32.2 23.8L33 23.7L34 31.8L33.2 31.9ZM33.2 31.5L34 31.8L31.9 40.8L31.1 40.5ZM33.8 16.7L34.2 17.4L28.2 19.7L27.9 19ZM32.3 24L32.8 24.6L28.7 28.2L28.2 27.6ZM33.5 32L34.1 32.5L38.1 36.8L37.5 37.3ZM14.4 6.5L15.2 6.7L13.8 13.1L13 12.9ZM13.3 12.7L14 12.4L16.5 18.2L15.7 18.5ZM13.7 12.5L14.1 13.2L10.3 15.5L9.9 14.8ZM50.8 7L51.6 7.2L50.2 13.3L49.4 13.1ZM49.7 12.9L50.5 12.7L52.2 19.1L51.4 19.3ZM50.2 13L50.6 13.7L55.2 16.1L54.8 16.8Z";
    internal const string SpeakerPathData = "M8.5 18H19.5L32.5 8V40L19.5 30H8.5ZM36.5 17C40.5 21 40.5 27 36.5 31L39.5 34C45.5 28 45.5 20 39.5 14ZM44.5 10C53.5 18 53.5 30 44.5 38L47.5 42C59.5 32 59.5 16 47.5 6Z";
    internal const string QuestionMarkPathData = "M17.5 15C17.5 7 23.5 2 32.5 2C41.5 2 47.5 7.5 47.5 15.5C47.5 22 44 25 39 28C35 30.4 33.5 32.2 33.5 36H25.5C25.5 28.2 28.5 24.5 34.5 21C38 19 39.5 17.7 39.5 15C39.5 11.4 36.7 9 32.5 9C28.3 9 25.5 11.4 25.5 15ZM29.5 38A4 4 0 1 0 29.5 46A4 4 0 1 0 29.5 38Z";
    ...
    [
        ...
        new(VoicePresenceState.Connected, "discord-connected.svg",
            SpeakerPathData, null, null, "AeziolSuccess"),
